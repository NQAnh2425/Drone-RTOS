...
__weak void PID_setting()
{
	uint8_t pid_setting_buff[15] = {0};
	uint16_t rx_len;
	LOG("setting syntax: P I D\n");
	LOG("example: 2 0.02 0.5 correspond P = 2, I = 0.02, D = 0.5\n");
	LOG("setting Pitch PID:\n ");
	__HAL_UART_CLEAR_IDLEFLAG(&huart2);
	if(HAL_UART_Receive(&huart2, pid_setting_buff, 15, 10000) == HAL_OK)
	{
	    pid_setting_buff[15] = '\0';
